...
- Un lenguaje de la clase CO-RE no necesariamente tiene una MT que lo acepte, a menos que sea R.
- Todo lenguaje CO-RE tiene una MT que reconoce su complemento, pero esto no implica que haya una MT que acepte directamente el lenguaje en CO-RE.
- Si un lenguaje es CO-RE pero no REC, entonces no existe una MT que lo acepte.
...
También podemos pensar que si tenemos un lenguage L ∈ R, entonces su complemento LC ∈ R, en este caso L es el lenguaje de todas las cadenas y LC es el lenguaje que no reconoce ninguna cadena.
...
### Tener en cuenta que en este caso la MT puede ejecutar en "paralelo" o de manera secuencial y seria exactamente lo mismo
